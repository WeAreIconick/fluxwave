...
export default function Edit( { attributes, setAttributes } ) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody
					title={ __( 'Player Settings', 'fluxwave' ) }
					initialOpen={ true }
				>
					<ToggleControl
				...
				<PanelBody
					title={ __( 'Accent Color', 'fluxwave' ) }
					initialOpen={ true }
				>
					<ColorPalette
						value={ accentColor }
						onChange={ ( color ) =>
							setAttributes( { accentColor: color || '#06b6d4' } )
						}
						colors={ [
							{
								name: __( 'Cyan', 'fluxwave' ),
								color: '#06b6d4',
							},
							{
								name: __( 'Blue', 'fluxwave' ),
								color: '#3b82f6',
							},
							{
								name: __( 'Indigo', 'fluxwave' ),
								color: '#6366f1',
							},
							{
								name: __( 'Purple', 'fluxwave' ),
								color: '#a855f7',
							},
							{
								name: __( 'Pink', 'fluxwave' ),
								color: '#ec4899',
							},
							{ name: __( 'Red', 'fluxwave' ), color: '#ef4444' },
							{
								name: __( 'Orange', 'fluxwave' ),
								color: '#f97316',
							},
							{
								name: __( 'Amber', 'fluxwave' ),
								color: '#f59e0b',
							},
							{
								name: __( 'Yellow', 'fluxwave' ),
								color: '#eab308',
							},
							{
								name: __( 'Lime', 'fluxwave' ),
								color: '#84cc16',
							},
							{
								name: __( 'Green', 'fluxwave' ),
								color: '#10b981',
							},
							{
								name: __( 'Emerald', 'fluxwave' ),
								color: '#059669',
							},
							{
								name: __( 'Teal', 'fluxwave' ),
								color: '#14b8a6',
							},
						] }
					/>
			...
			<div { ...blockProps }>
				...
				<div className="mb-4 flex items-center justify-between border-b border-gray-200 pb-3">
					<SelectControl
						...
						options={ [
							{
								label: __( 'Edit Playlist', 'fluxwave' ),
								value: 'editor',
							},
							{
					...
					{ viewMode === 'preview' && (
						<span className="text-xs text-gray-500">
							{ __(
								'This is how your player will look on the frontend',
								'fluxwave'
							) }
						</span>
					) }
